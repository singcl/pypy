...
class Encrypyed():
  ...
  def aes_encrypt(self, text, secKey):
    ...
    encryptor = AES.new(secKey.encode(
      'utf-8'), AES.MODE_CBC, b'0102030405060708')
...
class Crawler():
  ...
  def search(self, search_content, search_type, limit=9):
    ...
    params = {'s': search_content, 'type': search_type,
                    'offset': 0, 'sub': 'false', 'limit': limit}
